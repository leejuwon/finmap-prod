...
function normalizeHreflangAlternates(rawAlternates) {
  ...
  for (const lang of ['ko', 'en']) {
    ...
    if (trimmed) alternates[lang] = trimmed;
  }

  return Object.keys(alternates).length ? alternates : null;
}
...
function buildPostFromPath(fullPath, lang, slug) {
  ...
  return {
    ...
    hreflangAlternates: normalizeHreflangAlternates(data.hreflangAlternates),
    contentHtml: html,
    tools,
    ...readingStats,
  };
