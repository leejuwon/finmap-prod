...
const SAMPLES = [
  ...
  { path: '/tools/mortgage-loan-calculator', lang: 'ko', group: 'tool-detail' },
  { path: '/en/tools/mortgage-loan-calculator', lang: 'en', group: 'tool-detail' },
  { path: '/en/tools/home-buying-budget-calculator', lang: 'en', group: 'tool-detail' },
