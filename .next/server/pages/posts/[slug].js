...
/* harmony export */   "Z": () => (/* binding */ JsonLd)
/* harmony export */ });
...
/* harmony import */ var _components_JsonLd__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6130);
...
function PostPage({ post  }) {
    ...
    const jsonld = {
        ...
        "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": `https://www.finmaphub.com${url}`
        }
    };
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_JsonLd__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
                data: jsonld
            }),
...
async function getStaticPaths() {
    const slugs = (0,_lib_posts__WEBPACK_IMPORTED_MODULE_3__/* .getAllSlugs */ .m)();
    return {
        paths: slugs.map((s)=>({
                params: {
                    slug: s
...
async function getStaticProps({ params  }) {
    const post = (0,_lib_posts__WEBPACK_IMPORTED_MODULE_3__/* .getPostBySlug */ .zQ)(params.slug);
    return {
        props: {
            post
        }
