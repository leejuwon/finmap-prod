...
| 항목 | 입력값 |
| --- | --- |
| 운영 배포일 `T0` | `2026-06-04` |
| 기준 기간 | `2026-05-21 ~ 2026-06-03` |
| 적용 후 기간 | `2026-06-05 ~ 2026-06-18` |
| 데이터 추출 1차 | `2026-06-18` |
| 최종 데이터 추출 예정 | `2026-06-20 ~ 2026-06-21` |
| 기준 timezone | KST |
| 배포 중 장애/캠페인/대형 이슈 |  |

2026-06-17 전후:
네이버 일반 검색 급락 대응으로 KO 대표 URL 3개에 검색어 매칭 복구 작업 진행.
canonical/hreflang/robots/sitemap/광고/계산기 코드는 변경하지 않음.
