 ...
 *
 * 예)
 *  node server/crawler/scripts/re_build_stats_ranks.js --sido=41 --level=sigungu --from=202501 --to=202512 --top=100 --timeframe=both --only=all
 *  node server/crawler/scripts/re_build_stats_ranks.js --sido=28 --level=sigungu --from=202501 --to=202512 --top=100 --timeframe=both --only=all
 *  node server/crawler/scripts/re_build_stats_ranks.js --sido=11 --level=dong    --from=202501 --to=202512 --top=100 --timeframe=both --only=all
 */
'use strict';
