...
<script type="application/ld+json">
{
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.finmaphub.com/en/posts/economicInfo/policy-rate-cut-market-rates"
  },
  "image": [
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Why didn’t my loan rate fall after a policy rate cut?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Most loans price off market-based reference rates (e.g., funding/bond benchmarks) plus a bank spread. If market rates, credit spreads, or bank margins stay high, your borrowing cost may not drop even when the policy rate is cut."
      }
    },
    {
      "@type": "Question",
      "name": "What’s the difference between policy rates and market rates?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Policy rates are set by a central bank and primarily influence very short-term money market conditions. Market rates are yields formed by investors in bonds and credit markets based on expectations and risk premia."
      }
    },
    {
      "@type": "Question",
      "name": "Do rate cuts always lift stocks?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Not always. If cuts occur because growth is deteriorating or credit stress is rising, earnings expectations can fall and risk appetite can shrink, offsetting any valuation boost from lower rates."
      }
    },
    {
      "@type": "Question",
      "name": "What indicators should I watch with rate news in Korea?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Track Korea’s government yields (3Y/10Y), the curve shape, credit spreads, USD/KRW, and U.S. 10-year yields (TNX). Together they show whether policy decisions are translating into market pricing and capital flows."
      }
    },
    {
      "@type": "Question",
      "name": "How can market yields rise when a central bank cuts rates?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Long yields can rise if inflation expectations increase, term premium widens, fiscal or volatility risk grows, or credit/liquidity conditions tighten—even if the policy rate is lowered."
      }
    }
  ]
}
...
1) **Your reference rate** (what your loan is indexed to)  
2) **Your spread** (bank margin + credit risk + product pricing)
...
1) the policy statement tone (not just the cut size)  
2) 3-year government yield (short-to-mid expectations)  
3) 10-year government yield (long expectations + term premium)  
4) curve slope (10Y–3Y) as a growth/expectation signal  
5) credit spreads (corporate vs government)  
6) bank funding yields (where available)  
7) USD/KRW (risk appetite / flows)  
8) TNX (global discount rate)  
9) whether the move was priced ahead of the meeting
...
<div class="img-row">
  <figure>
    <img src="https://res.cloudinary.com/dwonflmnn/image/upload/v1768210077/blog/tools/policy-rate-cut-img1.png" alt="Decision vs price: policy rates vs market rates" />
    <figcaption>Policy rate is a decision; market rates are prices shaped by expectations and risk</figcaption>
  </figure>
  <figure>
    <img src="https://res.cloudinary.com/dwonflmnn/image/upload/v1768210078/blog/tools/policy-rate-cut-img2.png" alt="Four drivers of long yields: expectations, inflation, term premium, spreads" />
    <figcaption>Long yields move on inflation expectations, the expected path of short rates, term premium, and spreads</figcaption>
  </figure>
  <figure>
    <img src="https://res.cloudinary.com/dwonflmnn/image/upload/v1768210079/blog/tools/policy-rate-cut-img3.png" alt="Korea overlay: TNX and USD/KRW influence local yields and flows" />
    <figcaption>In Korea, TNX and USD/KRW often decide whether policy cuts translate into real borrowing costs</figcaption>
  </figure>
</div>
