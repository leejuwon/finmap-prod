...
- 결론은 단순합니다. 전쟁 테마는 ‘승자 찾기’가 아니라 **마진이 바뀌는 경로**를 추적하는 게임입니다.  
...
<div class="hero-grid">
  <div class="hero-card hero-main">
    ...
    <ul>
      ...
      <li><strong>과열 회피</strong>: “유동성 급등”과 “펀더멘털 전이”를 구분하는 신호표 + 체크리스트</li>
    </ul>
  </div>
...
<div class="callout-tip">
  ...
  전쟁 테마의 핵심은 “승자 찾기”가 아니라 “비용과 환율이 마진을 어디서부터 바꾸는지”를 먼저 보는 것입니다.
</div>
...
[원/달러가 ‘업종별’로 다르게 작동하는 이유(체크리스트)](/posts/investingInfo/usd-krw-weak-won-sector-map-kospi)
...
- 방산: <strong>수주(백로그) → 생산 → 납품 → 정산</strong>의 시간이 길고, 계약 조건이 중요합니다.  
