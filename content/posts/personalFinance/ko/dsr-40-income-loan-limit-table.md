...
이 글은 DSR 40%, 금리 4.0%, 30년 원리금균등 상환 기준으로 연봉별 주담대 한도를 정리한 자료형 글입니다. 내 보유 현금, LTV, 기존부채까지 같이 보려면 먼저 [DSR/LTV 계산기](/tools/dsr-ltv-calculator)에 직접 입력해 보세요.
...
> **표는 빠른 참고용입니다.** 기존부채·보유 현금·LTV까지 반영한 내 조건을 보려면 [DSR/LTV 계산기](/tools/dsr-ltv-calculator)를 사용하세요.
