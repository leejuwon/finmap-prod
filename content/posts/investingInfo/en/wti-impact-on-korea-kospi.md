...
<script type="application/ld+json">
{
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.finmaphub.com/en/posts/investingInfo/wti-impact-on-korea-kospi"
  },
  "image": [
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Does higher WTI always mean the KOSPI will fall?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Not always. It depends on whether the move is demand-led (growth/reflation) or supply-led (disruption/cost shock), and how USD/KRW and rate expectations react."
      }
    },
    {
      "@type": "Question",
      "name": "What is the first place oil shocks show up in Korea?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Often in energy and transport costs, then inflation measures, then rate expectations/financial conditions, and finally in earnings and foreign flows."
      }
    },
    {
      "@type": "Question",
      "name": "Why should I watch USD/KRW together with WTI?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Crude is priced in USD, so oil moves can interact with USD strength. A simultaneous rise in WTI and USD/KRW can amplify import costs, inflation pressure, and flow sensitivity."
      }
    },
    {
      "@type": "Question",
      "name": "Which sectors tend to be hurt or helped by oil moves?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It depends on cost structure and pass-through. Fuel-intensive sectors can suffer during spikes, while refining/energy-linked names may benefit if margins improve. Focus on margins, not labels."
      }
    },
    {
      "@type": "Question",
      "name": "What’s the simplest monitoring bundle for personal investors?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "WTI direction and speed, USD/KRW, an inflation/rates lens, and DXY to confirm broad USD strength."
      }
    }
  ]
}
...
<div class="hero-grid">
  <div class="hero-main">
    ...
    <p class="hero-summary">
      In Korea, WTI typically transmits through a five-step chain:
      (1) input and transport costs →
      (2) inflation pressure (CPI/PPI and expectations) →
      (3) interest-rate expectations and discount rates →
      (4) USD pricing and USD/KRW dynamics →
      (5) earnings revisions and foreign investor flows.
      The KOSPI reacts most sharply when oil shocks lift inflation expectations and push USD/KRW higher at the same time.
    </p>
  </div>

  <div class="hero-card">
    <h3>Three lines to remember</h3>
    <ul>
      <li>WTI ↑ → costs and inflation pressure ↑</li>
      <li>Inflation ↑ → rates/discount pressure can rise</li>
      <li>USD pricing → USD/KRW can amplify the shock</li>
    </ul>
  </div>
</div>

<div class="callout-tip">
  <strong>Key idea:</strong> The market impact is less about “oil up” and more about whether oil changes <em>inflation</em>, <em>rates</em>, and <em>FX</em> expectations together.
</div>
...
<div class="compare-grid">
  <div class="compare-card compare-bad">
    ...
    <ul>
      <li>WTI up → KOSPI down (always)</li>
      <li>Refiners automatically win from higher oil</li>
      <li>FX is secondary—oil alone explains it</li>
      <li>One headline explains the whole move</li>
    </ul>
  </div>
  <div class="compare-card compare-good">
    <h3>Better framework</h3>
    <ul>
      <li>Classify the move: demand-led vs supply-led</li>
      <li>Watch the bundle: WTI + inflation/rates + USD/KRW + DXY</li>
      <li>Think in margins and pass-through, not sector labels</li>
      <li>Separate “flow shock” from “earnings reprice”</li>
    </ul>
  </div>
</div>
...
<div class="callout-tip">
  <strong>Practical tip:</strong> For Korea, oil becomes most dangerous when it comes with <em>KRW weakness</em> and <em>rising inflation expectations</em>—that’s when multiple channels align.
</div>
...
<div class="img-row">
  <figure>
    ...
    <figcaption>WTI ↑ → input/transport costs ↑ → margins and earnings expectations shift</figcaption>
  </figure>
  <figure>
    ...
    <figcaption>Oil ↑ → inflation pressure ↑ → discount-rate risk ↑ → growth sensitivity rises</figcaption>
  </figure>
  <figure>
    ...
    <figcaption>USD pricing + USD strength → USD/KRW ↑ → flow pressure and volatility amplify</figcaption>
  </figure>
</div>
...
<div class="tool-cta">
  <h3>Prefer a process over timing?</h3>
  <p>
    Oil shocks can trigger fast rotations and noisy headlines.
    A simple DCA simulation helps you define contribution size and horizon so volatility becomes a plan—not a surprise.
  </p>
