...
<div class="hero-grid">
  <div class="hero-main">
    <p class="hero-kicker">TNX is the world's benchmark discount rate</p>
    <p class="hero-summary">
      When TNX rises, global asset pricing resets.  
      Growth sectors suffer first, EM markets lose capital, and USD strengthens.  
      This chain reaction explains why many ETFs move together during yield spikes.
    </p>
  </div>

  <div class="hero-card">
    <h3>Main Signals from TNX</h3>
    <ul>
      <li>Growth ETF valuation compression</li>
      <li>Emerging-market capital outflows</li>
      <li>Bond ETF decline (TLT, IEF)</li>
      <li>USD strength → EM currency weakness</li>
    </ul>
  </div>
</div>
...
<div class="compare-grid">
  <div class="compare-card compare-bad">
    <h3>Growth ETFs Under High TNX</h3>
    <ul>
      <li>Severe valuation compression</li>
      <li>High volatility during rate spikes</li>
      <li>Cash flow far in the future → duration risk</li>
      <li>Largest drawdowns during tightening cycles</li>
    </ul>
  </div>

  <div class="compare-card compare-good">
    <h3>Value ETFs Under High TNX</h3>
    <ul>
      <li>More stable earnings structure</li>
      <li>Financials benefit from higher yields</li>
      <li>Less sensitive to discount-rate changes</li>
      <li>Often outperform during early tightening</li>
    </ul>
  </div>
</div>
...
When TNX rises:
1. U.S.-bound capital increases  
2. USD strengthens  
3. EM currencies weaken  
4. Dollar-denominated debt pressure increases  
5. EM ETF returns fall sharply
...
<div class="img-row">
  <figure>
    ...
    <figcaption>Rising TNX → stronger USD → EM pressure</figcaption>
  </figure>
  <figure>
    <img src="https://res.cloudinary.com/dwonflmnn/image/upload/v1764561424/blog/investingInfo/etf-impact-of-tnx-2.png" alt="Emerging market sensitivity" />
    <figcaption>EM ETFs react to both yields and FX</figcaption>
  </figure>
  <figure>
    <img src="https://res.cloudinary.com/dwonflmnn/image/upload/v1764561427/blog/investingInfo/etf-impact-of-tnx-3.png" alt="Korea ETF structure" />
    <figcaption>Korea’s tech-heavy ETF structure increases risk</figcaption>
  </figure>
</div>
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "How U.S. 10Y Yield (TNX) Affects ETFs",
  "description": "A complete guide on how TNX affects global ETF performance, growth valuations, emerging markets, and Korea.",
  "datePublished": "2025-12-01",
  "dateModified": "2025-12-01",
