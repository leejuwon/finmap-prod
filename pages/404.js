    ...
    <>
      ...
      <div className="container py-16 text-center">
        ...
        <div className="flex gap-3 justify-center">
          ...
          <Link href="/category/economicInfo" className="px-4 py-2 rounded-lg border">경제정보</Link>
          <Link href="/category/personalFinance" className="px-4 py-2 rounded-lg border">재테크</Link>
          <Link href="/category/investingInfo" className="px-4 py-2 rounded-lg border">투자정보</Link>
        </div>
      </div>
    </>
  );
